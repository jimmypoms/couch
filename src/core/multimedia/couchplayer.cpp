...
void CouchPlayer::addPlaybackHandler(PlaybackHandler *handler)
{
    ...
    connect(handler, &PlaybackHandler::positionChanged, this,
            &CouchPlayer::positionChanged);
    connect(handler, &PlaybackHandler::durationChanged, this,
            &CouchPlayer::durationChanged);
